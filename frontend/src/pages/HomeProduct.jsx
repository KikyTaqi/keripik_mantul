                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex flex-row-reverse">
                          <Link to={`/checkout/${product._id}`}>
                            <Button type="secondary" icon={<ShoppingCartOutlined style={{fontSize: '24px'}}/>} className="bottom-0 ms-0 text-base border-none hover:text-red-700" />
                          </Link>
                          <Link to={`/`}>
                            <Button type="secondary" icon={<FaRegHeart style={{fontSize: '20px'}}/>} className="bottom-0 text-base border-none hover:text-red-700" />
                          </Link>
                        </div>
                      </div>
                    </Card>
